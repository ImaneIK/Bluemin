<template>
      ...
      <nav class="relative px-24 py-2 flex justify-between items-center bg-white">
        <!-- logo -->
        ...
        <!-- burger button -->
        <div class="lg:hidden" ref="burger" @click="toggleMenu">
        ...
        >
          ...
          <li>
            <a class="text-sm text-gray-400 hover:text-gray-500" href="#">Pricing</a>
          </li>
          <li class="text-gray-300">
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div ref="menu" :class="{ hidden: !menuVisible }" class="relative z-60">
        <div class="navbar-backdrop fixed inset-0 bg-gray-800 opacity-25"></div>
        <nav
          class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto"
        >
          <div ref="close" @click="closeMenu" class="flex items-center mb-8">
