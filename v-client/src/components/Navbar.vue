<template>
      ...
      <nav class="relative px-8 md:px-24 py-2 flex justify-between items-center bg-white">
        <!-- logo -->
        <router-link to="/"  class="text-3xl font-bold leading-none" href="#">
  ...
  <button
    v-if="$auth.isAuthenticated"
    @click="logout"
    class="  py-2 px-6 bg-red-500 hover:bg-red-600 text-sm text-white font-bold rounded-xl transition duration-200"
  >
    Logout
  </button>
</div>
