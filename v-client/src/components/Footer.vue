...
<footer class="bg-white">
      <div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24  bg-gray-50">


        <div class="space-y-5 sm:text-center sm:max-w-md sm:mx-auto">
          <h1 class="text-gray-800 text-3xl font-extrabold sm:text-4xl">
            Latest blog posts
          </h1>
          ...
          <form @submit.prevent class="items-center justify-center gap-3 sm:flex">
            ...
            <button
              type="submit"
              class="block w-full mt-3 py-3 px-4 font-medium text-sm text-center text-white bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 active:shadow-none rounded-lg shadow sm:mt-0 sm:w-auto"
            >
              Subscribe
            </button>
          </form>
